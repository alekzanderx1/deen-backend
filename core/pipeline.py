...
def chat_pipeline_streaming(user_query: str, session_id: str):
    ...
    response_generator = stream_generator.generate_response_stream(user_query, all_relevant_docs, session_id)
